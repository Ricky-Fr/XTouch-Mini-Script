...
CLAUDE AI in XTouch Mini IS COMING... see my another repository
...
3. Extract all files to `C:\ProgramData\Ableton\Live 12 Standard\Resources\MIDI Remote Scripts\XTouch_Mini` folder without any subfolder
4. Restart Ableton
